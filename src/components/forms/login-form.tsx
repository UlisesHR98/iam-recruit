    ...
    >
      <FieldGroup>
        ...
        <Button
          type="button"
          variant="outline"
          className="w-full rounded-full bg-white dark:bg-surface-dark border-slate-200 dark:border-border-dark"
        >
          <span className="material-symbols-outlined text-[20px] mr-2 text-slate-500 dark:text-text-muted-dark">
            domain
          </span>
          Single Sign-On (SSO)
        </Button>
